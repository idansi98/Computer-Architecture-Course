...
//	char temp;                // temporary color storage for bgr-rgb conversion. // (USED FOR DEBUGGING IN ORIGINAL CODE)
	unsigned char temp;                // temporary color storage for bgr-rgb conversion. // (USED FOR DEBUGGING IN ORIGINAL CODE)
